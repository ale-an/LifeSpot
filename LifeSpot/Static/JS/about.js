...
function getReview() {
    ...
    if (confirm("Вы хотите, чтобы ваш комментарий оценили другие пользователи?")) {
        let reviewWithRate = Object.create(review);
        reviewWithRate.rate = 0;
        writeReview(reviewWithRate);
